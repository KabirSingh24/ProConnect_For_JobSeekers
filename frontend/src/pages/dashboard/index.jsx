...
import { createPost, deleteComment, deletePost, getAllComments, getAllPosts, incrementLike, postComment } from "@/config/redux/action/postAction";
                    ...
                    <div className={styles.wrapper}>
                        <div className={styles.scrollComponent}>
                            <div className={styles.createPostContainer}>
                                <img className={styles.userProfile} src={`${authState.user.profilePicture}`} alt="" />
                                <textarea onChange={(e) => setPostContent(e.target.value)}
                                    value={postContent} className={styles.textAreaContent} placeholder="Start a Post" name="" id=""></textarea>
                            ...
                            <div className={styles.postsContainer}>
                                {postState.posts.map((post) => {
                                    return (
                                        <div key={post.postId} className={styles.singleCard}>
                                            <div className={styles.singleCard_profileContainer}>
                                                ...
                                                <div>
                                                    ...
                                                    <p style={{ color: "grey" }}>{post.user.name}</p>
                                                    <p style={{ paddingTop: "1.3rem" }}>{post.body}</p>



                                                    <div className={styles.singleCard_img}>
                                                        <img className={styles.postImage} src={`${post.fileUrl}`} />
                                                    </div>
                                                    ...
                                                    <div className={styles.optionsContainer}>
                                                        <div onClick={async () => {
                                                            await dispatch(incrementLike(post.postId))
                                                            dispatch(getAllPosts())
                                                        ...
                                                        <div onClick={() => {
                                                            ...
                                                            const url = encodeURIComponent(`${authState.user.email}`);
                        ...
                        <div onClick={() => {
                            ...
                            <div onClick={(e) => e.stopPropagation()} className={styles.allCommentsConatiner}>
                                            ...
                                            return (
                                                <div className={styles.singleComment} key={comment.id}>
                                                    <div className={styles.singleComment_profilePicture}>
                                                        <img style={{ width: "1.2rem", height: "1.5rem", fontSize: "1.2rem" }} src={`${comment.profilePicture}`} alt="" />
                                                        <div>
                                                            <p style={{ fontWeight: "bold", fontSize: "1.2rem" }}>{comment.name}</p>
                                ...
                                <div className={styles.postCommentContainer}>
                                    ...
                                    <div onClick={async () => {
                                        await dispatch(postComment({ postId: postState.postId, body: commentText, token: localStorage.getItem("token") }))
